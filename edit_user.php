                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <select class="form-control" id="editUserLevel" name="userlevel" required>
                                    ...
                                    <option value="0" <?php if ($user['userlevel'] == '0') echo 'selected'; ?>>ผู้ดูแลระบบ</option>
                                    <option value="1" <?php if ($user['userlevel'] == '1') echo 'selected'; ?>>อาจารย์</option>
                                    <option value="2" <?php if ($user['userlevel'] == '2') echo 'selected'; ?>>เทรนเนอร์</option>
                                    <option value="3" <?php if ($user['userlevel'] == '3') echo 'selected'; ?>>สมาชิก</option>
                                    <option value="4" <?php if ($user['userlevel'] == '4') echo 'selected'; ?>>ผู้ใช้ทั่วไป</option>
                                </select>
                            </div>
                            <div class="form-group col-md-6" id="editTypeContainer" style="<?php if ($user['userlevel'] != '3') echo 'display: none;'; ?>" required>
                                ...
                                <select name="type" class="form-control" id="editType">
                                    ...
                                    <option value="1" <?php if ($user['type'] == '1') echo 'selected'; ?>>บุคลากร</option>
                                    <option value="2" <?php if ($user['type'] == '2') echo 'selected'; ?>>บุคคลทั่วไป</option>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <select class="form-control" id="editStatus" name="status" required>
                                    <option value="">เลือกสถาานะ</option>
                                    <option value="0" <?php if ($user['status'] == '0') echo 'selected'; ?>>ยังเป็นสมาชิก</option>
                                    <option value="1" <?php if ($user['status'] == '1') echo 'selected'; ?>>ใกล้หมดอายุ</option>
                                    <option value="2" <?php if ($user['status'] == '2') echo 'selected'; ?>>หมดอายุ</option>
                                    <option value="3" <?php if ($user['status'] == '3') echo 'selected'; ?>>ไม่ได้เป็นสมาชิก</option>
                                    <option value="4" <?php if ($user['status'] == '4') echo 'selected'; ?>>บุคลากร</option>
                                </select>
                            </div>
                            <div class="form-group col-md-6">
                                <label for="editRecordDate" class="form-label">วันที่บันทึกเข้าระบบ</label>
                                <input type="datetime-local" name="recorddate" class="form-control" id="editRecordDate" value="<?php echo date('Y-m-d\TH:i', strtotime($user['recorddate'])); ?>">
                            </div>
                        </div>
