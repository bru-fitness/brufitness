...
$sql = "SELECT service_date FROM service_usage ";
...
<head>
    ...
    <title>ประวัติการเข้าใช้บริการด้วยตัวเอง</title>
    <!-- Basic meta tags -->
    <meta charset="utf-8">
    ...
    <link
        href="https://fonts.googleapis.com/css2?family=Chakra+Petch:ital,wght@0,200;0,300;0,400;0,500;0,600;0,700;1,200;1,300;1,400;1,500;1,600;1,700&family=Mitr:wght@200;300;400;500;600;700&display=swap"
        rel="stylesheet">
    <style>
    ...
    <div class="inner_container">
        ...
        <nav id="sidebar">
            ...
            <div class="sidebar_blog_2">
                ...
                <ul class="list-unstyled components">
                    <li class="active">
                        <a href="#service" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle"><i
                                class="fa-solid fa-clock-rotate-left"></i> <span>ประวัติการเข้าใช้บริการ</span></a>
        ...
        <div id="content">
            ...
            <div class="container mt-5 content">
                <h3>ประวัติการเข้าใช้บริการด้วยตัวเอง</h3>
                <br>
                <table class="table">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        ...
                        // Query ที่จะดึงข้อมูลวันที่เฉพาะ user_id นั้นๆ
                        $sql = "SELECT service_date FROM service_usage WHERE user_id = ?  AND record_id = 1";
                        $stmt = $conn->prepare($sql);
